			...
			<footer id="colophon" class="site-footer" role="contentinfo">
				...
				<div class="site-contact">
					...
					<ul class="fa-ul">
						...
						<li><a class="hidden facebook" href="#" target="_black" rel="nofollow">
							<span class="fa-li"><i class="fab fa-facebook-f"></i></span>http://facebook.com/inhabitent</a></li>
						<li><a class="hidden twitter" href="#" target="_black" rel="nofollow">
							<span class="fa-li"><i class="fab fa-twitter"></i></span>http://twitter.com/inhabitent</a></li>
						<li><a class="hidden googlePlus" href="#" target="_black" rel="nofollow">
